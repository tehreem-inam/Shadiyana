...
>
    ...
    <div class="mb-6">
        ...
        <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-gray-500">
                            Manage states and provinces across your locations.
                        </p>
            ...
            {{-- Add State --}}
            <a
                href="{{ route('locations.states.create') }}"
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-2xl font-extrabold tracking-tight text-gray-900">
                        {{ $states->where('status', 'active')->count() }}
                    </p>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-2xl font-extrabold tracking-tight text-gray-900">
                        {{ $states->where('status', 'inactive')->count() }}
                    </p>
            ...
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-xs text-gray-500">
                        View and manage all registered states.
                    </p>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @forelse($states as $state)
                        ...
                        <tr
                            x-show="
                                (search === '' ||
                                '{{ strtolower($state->name) }}'.includes(search.toLowerCase()) ||
                                '{{ strtolower($state->country?->name ?? '') }}'.includes(search.toLowerCase()))
                                &&
                                (status === 'all' || status === '{{ $state->status }}')
                            "
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#FBEBEF] text-sm font-extrabold text-[#D7385E]">
                                        {{ strtoupper(substr($state->name, 0, 1)) }}
                                    </div>
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    {{-- Edit --}}
                                    <a
                                        href="{{ route('locations.states.edit', $state->id) }}"
                                        title="Edit State"
                                    ...
                                    <button
                                        ...
                                        @click="$dispatch('confirm-delete', {
                                            url: '{{ route('locations.states.destroy', $state->id) }}',
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-gray-500">
                                ...
                                <span class="inline-flex items-center gap-1.5">
                                    ...
                                    {{ $state->cities_count ?? $state->cities->count() }}
                                    {{ ($state->cities_count ?? $state->cities->count()) === 1 ? 'City' : 'Cities' }}
            ...
            @empty
                ...
                <div class="px-6 py-16 text-center">
                    ...
                    <div class="mx-auto flex max-w-sm flex-col items-center">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Start by adding your first state.
                        </p>
