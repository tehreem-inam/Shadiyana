        ...
        <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    View detailed information about this state or province.
                </p>
    ...
    <div class="mt-6 flex flex-col gap-3 rounded-2xl border border-red-100 bg-red-50 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
        ...
        <div>
            ...
            <p class="mt-1 max-w-2xl text-xs leading-5 text-red-600">
                Permanently remove this state from the location management system.
        ...
        <form
            action="{{ route('locations.states.destroy', $state->id) }}"
            method="POST"
            onsubmit="return confirm('Are you sure you want to delete {{ $state->name }}? This action cannot be undone.');"
        >
